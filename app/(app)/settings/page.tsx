      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:18 }}>
        ...
        <div>
          ...
          <div className="mc-card">
            ...
            <div style={{ fontSize:12, color:'#6b7280', marginBottom:12 }}>Configure via Supabase Auth — invite users from your Supabase dashboard.</div>
            {([
            ...
            ] as [string,string,string][]).map(([r,d,b]) => (
